    ...
    static var emails: [Email] {
        [
            ...
            Email(
                ...
                description: "Now until December 2, help your favorite books take home the win in the annual " +
                    "Goodreads Choice Awards, the only major book awards decided by you, the readers!"
            ),
            Email(
                sender: "Apple",
                time: "15:05",
